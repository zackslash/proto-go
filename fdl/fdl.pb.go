...
type ListItemsResponse struct {
	ListName string              `protobuf:"bytes,1,opt,name=list_name,json=listName" json:"list_name,omitempty"`
	Items    []*ListItemResponse `protobuf:"bytes,2,rep,name=items" json:"items,omitempty"`
}
...
type ListRangeRequest struct {
	...
	EndKey         string `protobuf:"bytes,3,opt,name=end_key,json=endKey" json:"end_key,omitempty"`
	Limit          int32  `protobuf:"varint,4,opt,name=limit" json:"limit,omitempty"`
	InclusiveStart bool   `protobuf:"varint,5,opt,name=inclusive_start,json=inclusiveStart" json:"inclusive_start,omitempty"`
	InclusiveEnd   bool   `protobuf:"varint,6,opt,name=inclusive_end,json=inclusiveEnd" json:"inclusive_end,omitempty"`
}
...
var fileDescriptor0 = []byte{
	...
	,
}
